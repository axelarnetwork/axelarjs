...
const SvgAxelarBlue = (props: SVGProps<SVGSVGElement>) => (
  <svg
    data-name="Layer 2"
  ...
  >
    ...
    <path
      ...
      fill="url(#axelar-blue_svg__a)"
      filter="url(#axelar-blue_svg__b)"
      data-name="Layer 1"
    />
  </svg>
);
export default SvgAxelarBlue;
