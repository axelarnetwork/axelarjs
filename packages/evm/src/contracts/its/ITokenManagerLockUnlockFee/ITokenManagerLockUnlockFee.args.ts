...
export const encodeITokenManagerLockUnlockFeeAcceptOperatorshipData = ({
  fromOperator,
}: ITokenManagerLockUnlockFeeAcceptOperatorshipArgs) =>
  encodeFunctionData({
...
export const encodeITokenManagerLockUnlockFeeAddFlowLimiterData = ({
  flowLimiter,
}: ITokenManagerLockUnlockFeeAddFlowLimiterArgs) =>
  encodeFunctionData({
...
export const encodeITokenManagerLockUnlockFeeHasRoleData = ({
  account,
  role,
}: ITokenManagerLockUnlockFeeHasRoleArgs) =>
  encodeFunctionData({
...
export const encodeITokenManagerLockUnlockFeeIsOperatorData = ({
  addr,
}: ITokenManagerLockUnlockFeeIsOperatorArgs) =>
  encodeFunctionData({
...
export const encodeITokenManagerLockUnlockFeeParamsData = ({
  operator_,
  tokenAddress_,
}: ITokenManagerLockUnlockFeeParamsArgs) =>
  encodeFunctionData({
    functionName: "params",
    abi: ABI_FILE.abi,
...
export const encodeITokenManagerLockUnlockFeeProposeOperatorshipData = ({
  operator_,
}: ITokenManagerLockUnlockFeeProposeOperatorshipArgs) =>
  encodeFunctionData({
...
export const encodeITokenManagerLockUnlockFeeRemoveFlowLimiterData = ({
  flowLimiter,
}: ITokenManagerLockUnlockFeeRemoveFlowLimiterArgs) =>
  encodeFunctionData({
...
export const encodeITokenManagerLockUnlockFeeSetFlowLimitData = ({
  flowLimit_,
}: ITokenManagerLockUnlockFeeSetFlowLimitArgs) =>
  encodeFunctionData({
...
export const encodeITokenManagerLockUnlockFeeSetupData = ({
  data,
}: ITokenManagerLockUnlockFeeSetupArgs) =>
  encodeFunctionData({
    functionName: "setup",
    abi: ABI_FILE.abi,
    args: [data],
...
export const encodeITokenManagerLockUnlockFeeTakeTokenData = ({
  sourceAddress,
  amount,
}: ITokenManagerLockUnlockFeeTakeTokenArgs) =>
  encodeFunctionData({
...
export const encodeITokenManagerLockUnlockFeeTransferOperatorshipData = ({
  operator_,
}: ITokenManagerLockUnlockFeeTransferOperatorshipArgs) =>
  encodeFunctionData({
...
export const ITOKEN_MANAGER_LOCK_UNLOCK_FEE_ENCODERS = {
  acceptOperatorship: encodeITokenManagerLockUnlockFeeAcceptOperatorshipArgs,
  addFlowLimiter: encodeITokenManagerLockUnlockFeeAddFlowLimiterArgs,
  callContractWithInterchainToken:
    encodeITokenManagerLockUnlockFeeCallContractWithInterchainTokenArgs,
  giveToken: encodeITokenManagerLockUnlockFeeGiveTokenArgs,
  hasRole: encodeITokenManagerLockUnlockFeeHasRoleArgs,
  interchainTransfer: encodeITokenManagerLockUnlockFeeInterchainTransferArgs,
  isOperator: encodeITokenManagerLockUnlockFeeIsOperatorArgs,
  params: encodeITokenManagerLockUnlockFeeParamsArgs,
  proposeOperatorship: encodeITokenManagerLockUnlockFeeProposeOperatorshipArgs,
  removeFlowLimiter: encodeITokenManagerLockUnlockFeeRemoveFlowLimiterArgs,
  setFlowLimit: encodeITokenManagerLockUnlockFeeSetFlowLimitArgs,
  setup: encodeITokenManagerLockUnlockFeeSetupArgs,
  takeToken: encodeITokenManagerLockUnlockFeeTakeTokenArgs,
  transferOperatorship:
    encodeITokenManagerLockUnlockFeeTransferOperatorshipArgs,
  transmitInterchainTransfer:
    encodeITokenManagerLockUnlockFeeTransmitInterchainTransferArgs,
};
