...
export const encodeITokenManagerLockUnlockAcceptOperatorshipData = ({
  fromOperator,
}: ITokenManagerLockUnlockAcceptOperatorshipArgs) =>
  encodeFunctionData({
...
export const encodeITokenManagerLockUnlockAddFlowLimiterData = ({
  flowLimiter,
}: ITokenManagerLockUnlockAddFlowLimiterArgs) =>
  encodeFunctionData({
...
export const encodeITokenManagerLockUnlockHasRoleData = ({
  account,
  role,
}: ITokenManagerLockUnlockHasRoleArgs) =>
  encodeFunctionData({
...
export const encodeITokenManagerLockUnlockIsOperatorData = ({
  addr,
}: ITokenManagerLockUnlockIsOperatorArgs) =>
  encodeFunctionData({
...
export const encodeITokenManagerLockUnlockParamsData = ({
  operator_,
  tokenAddress_,
}: ITokenManagerLockUnlockParamsArgs) =>
  encodeFunctionData({
    functionName: "params",
    abi: ABI_FILE.abi,
...
export const encodeITokenManagerLockUnlockProposeOperatorshipData = ({
  operator_,
}: ITokenManagerLockUnlockProposeOperatorshipArgs) =>
  encodeFunctionData({
...
export const encodeITokenManagerLockUnlockRemoveFlowLimiterData = ({
  flowLimiter,
}: ITokenManagerLockUnlockRemoveFlowLimiterArgs) =>
  encodeFunctionData({
...
export const encodeITokenManagerLockUnlockSetFlowLimitData = ({
  flowLimit_,
}: ITokenManagerLockUnlockSetFlowLimitArgs) =>
  encodeFunctionData({
...
export const encodeITokenManagerLockUnlockSetupData = ({
  data,
}: ITokenManagerLockUnlockSetupArgs) =>
  encodeFunctionData({
    functionName: "setup",
    abi: ABI_FILE.abi,
    args: [data],
...
export const encodeITokenManagerLockUnlockTakeTokenData = ({
  sourceAddress,
  amount,
}: ITokenManagerLockUnlockTakeTokenArgs) =>
  encodeFunctionData({
...
export const encodeITokenManagerLockUnlockTransferOperatorshipData = ({
  operator_,
}: ITokenManagerLockUnlockTransferOperatorshipArgs) =>
  encodeFunctionData({
...
export const ITOKEN_MANAGER_LOCK_UNLOCK_ENCODERS = {
  acceptOperatorship: encodeITokenManagerLockUnlockAcceptOperatorshipArgs,
  addFlowLimiter: encodeITokenManagerLockUnlockAddFlowLimiterArgs,
  callContractWithInterchainToken:
    encodeITokenManagerLockUnlockCallContractWithInterchainTokenArgs,
  giveToken: encodeITokenManagerLockUnlockGiveTokenArgs,
  hasRole: encodeITokenManagerLockUnlockHasRoleArgs,
  interchainTransfer: encodeITokenManagerLockUnlockInterchainTransferArgs,
  isOperator: encodeITokenManagerLockUnlockIsOperatorArgs,
  params: encodeITokenManagerLockUnlockParamsArgs,
  proposeOperatorship: encodeITokenManagerLockUnlockProposeOperatorshipArgs,
  removeFlowLimiter: encodeITokenManagerLockUnlockRemoveFlowLimiterArgs,
  setFlowLimit: encodeITokenManagerLockUnlockSetFlowLimitArgs,
  setup: encodeITokenManagerLockUnlockSetupArgs,
  takeToken: encodeITokenManagerLockUnlockTakeTokenArgs,
  transferOperatorship: encodeITokenManagerLockUnlockTransferOperatorshipArgs,
  transmitInterchainTransfer:
    encodeITokenManagerLockUnlockTransmitInterchainTransferArgs,
};
