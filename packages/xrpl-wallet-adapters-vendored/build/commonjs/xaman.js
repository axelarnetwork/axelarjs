...
var _XamanWallet_instances, _XamanWallet_name, _XamanWallet_icon, _XamanWallet_accounts, _XamanWallet_client, _XamanWallet_sdk, _XamanWallet_listeners, _XamanWallet_connect, _XamanWallet_disconnect, _XamanWallet_signTransaction, _XamanWallet_signAndSubmitTransaction, _XamanWallet_on, _XamanWallet_emit, _XamanWallet_off, _XamanWallet_getXamanNetworkNameFromChain;
Object.defineProperty(exports, "__esModule", { value: true });
exports.XamanWallet = void 0;
...
class XamanWallet {
    ...
    constructor(apiKey) {
        ...
        _XamanWallet_signTransaction.set(this, async ({ tx_json, account, network }) => {
            ...
            const result = await __classPrivateFieldGet(this, _XamanWallet_sdk, "f").payload.get(uuid);
            if (!result || !result.response.hex)
                throw new Error('Invalid Payload Parameter');
            return {
                signed_tx_blob: result.response.hex,
            };
        });
        _XamanWallet_signAndSubmitTransaction.set(this, async ({ tx_json, account, network }) => {
            const createdPayload = await __classPrivateFieldGet(this, _XamanWallet_sdk, "f").payload.create({
                txjson: tx_json,
                options: { submit: true, force_network: __classPrivateFieldGet(this, _XamanWallet_instances, "m", _XamanWallet_getXamanNetworkNameFromChain).call(this, network) },
            });
            if (!createdPayload)
                throw new Error('Invalid Payload Parameter');
            const uuid = createdPayload.uuid;
            ...
            const payloadId = (await subscription.resolved);
            const payload = await __classPrivateFieldGet(this, _XamanWallet_sdk, "f").payload.get(payloadId);
            if (!payload || !payload.response.txid || !payload.response.dispatched_to)
                throw new Error('Invalid Payload');
            const client = new xrpl_1.Client(payload.response.dispatched_to);
            ...
            return {
                tx_json: transactionResponse.result,
                tx_hash: payload.response.txid,
            };
        });
        _XamanWallet_on.set(this, (event, listener) => {
            var _a;
            if (__classPrivateFieldGet(this, _XamanWallet_listeners, "f")[event])
                (_a = __classPrivateFieldGet(this, _XamanWallet_listeners, "f")[event]) === null || _a === void 0 ? void 0 : _a.push(listener);
            else
                __classPrivateFieldGet(this, _XamanWallet_listeners, "f")[event] = [listener];
            return () => __classPrivateFieldGet(this, _XamanWallet_instances, "m", _XamanWallet_off).call(this, event, listener);
        });
        if (new.target === XamanWallet) {
            Object.freeze(this);
        }
        __classPrivateFieldSet(this, _XamanWallet_client, new xumm_oauth2_pkce_1.XummPkce(apiKey), "f");
    }
}
exports.XamanWallet = XamanWallet;
_XamanWallet_name = new WeakMap(), _XamanWallet_icon = new WeakMap(), _XamanWallet_accounts = new WeakMap(), _XamanWallet_client = new WeakMap(), _XamanWallet_sdk = new WeakMap(), _XamanWallet_listeners = new WeakMap(), _XamanWallet_connect = new WeakMap(), _XamanWallet_disconnect = new WeakMap(), _XamanWallet_signTransaction = new WeakMap(), _XamanWallet_signAndSubmitTransaction = new WeakMap(), _XamanWallet_on = new WeakMap(), _XamanWallet_instances = new WeakSet(), _XamanWallet_emit = function _XamanWallet_emit(event, ...args) {
    var _a;
    (_a = __classPrivateFieldGet(this, _XamanWallet_listeners, "f")[event]) === null || _a === void 0 ? void 0 : _a.forEach((listener) => listener.apply(null, args));
}, _XamanWallet_off = function _XamanWallet_off(event, listener) {
    var _a;
    __classPrivateFieldGet(this, _XamanWallet_listeners, "f")[event] = (_a = __classPrivateFieldGet(this, _XamanWallet_listeners, "f")[event]) === null || _a === void 0 ? void 0 : _a.filter((existingListener) => listener !== existingListener);
}, _XamanWallet_getXamanNetworkNameFromChain = function _XamanWallet_getXamanNetworkNameFromChain(chain) {
    switch (chain) {
        case core_1.XRPL_MAINNET:
        case 'xrpl:mainnet':
            return 'MAINNET';
        case core_1.XRPL_TESTNET:
        case 'xrpl:testnet':
            return 'TESTNET';
        case core_1.XRPL_DEVNET:
        case 'xrpl:devnet':
            return 'DEVNET';
        case core_1.XAHAU_MAINNET:
        case 'xrpl:xahau-mainnet':
            return 'XAHAUMAINNET';
        case core_1.XAHAU_TESTNET:
