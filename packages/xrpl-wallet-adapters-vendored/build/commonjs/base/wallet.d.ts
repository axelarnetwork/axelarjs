import type { RequiredFetures, Wallet, XRPLIdentifierString, XRPLSignAndSubmitTransactionFeature, XRPLSignTransactionFeature } from '../core';
import type { XRPLWalletAccount } from './walletAccount';
export declare abstract class XRPLBaseWallet implements Wallet {
