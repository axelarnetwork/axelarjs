...
exports.MetaMaskWallet = exports.SNAP_ORIGIN = void 0;
const base_1 = require("./base");
const core_1 = require("./core");
exports.SNAP_ORIGIN = 'npm:xrpl-snap';
class MetaMaskWallet {
    constructor() {
        ...
        _MetaMaskWallet_connect.set(this, async ({ silent = false } = {}) => {
            ...
            __classPrivateFieldSet(this, _MetaMaskWallet_accounts, [new base_1.XRPLWalletAccount(snapAccount.account)], "f");
            __classPrivateFieldGet(this, _MetaMaskWallet_instances, "m", _MetaMaskWallet_emit).call(this, 'change', { accounts: this.accounts });
            return {
                accounts: __classPrivateFieldGet(this, _MetaMaskWallet_accounts, "f"),
            };
    ...
    get chains() {
        return [core_1.XRPL_MAINNET, core_1.XRPL_TESTNET, core_1.XRPL_DEVNET];
    }
    get features() {
        return {
            'standard:connect': {
