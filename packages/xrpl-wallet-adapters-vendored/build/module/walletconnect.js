...
export var DEFAULT_XRPL_METHODS;
...
})(DEFAULT_XRPL_METHODS || (DEFAULT_XRPL_METHODS = {}));
export class WalletConnectWallet {
    ...
    constructor({ projectId, metadata, networks, desktopWallets, mobileWallets }) {
        ...
        __classPrivateFieldSet(this, _WalletConnectWallet_chains, networks.map((network) => convertNetworkToChainId(network)), "f");
        __classPrivateFieldSet(this, _WalletConnectWallet_modal, new WalletConnectModal({
            projectId,
            chains: __classPrivateFieldGet(this, _WalletConnectWallet_chains, "f"),
