...
export const GMP_API_URLS = {
  ...
  ["devnet-amplifier"]: "https://devnet-amplifier.api.axelarscan.io/gmp",
} as const;

export type GMPAPIUrl = keyof typeof GMP_API_URLS;

export const AXELAR_CONFIG_API_URLS = {
  ["devnet-amplifier"]: "https://axelar-devnets.s3.us-east-2.amazonaws.com",
...
export const AXELAR_RPC_URLS_FALLBACK = {
  ...
  "devnet-amplifier": ["http://devnet-amplifier.axelar.dev:26657"],
} as const;
