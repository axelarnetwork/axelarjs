          ...
          {isConnected && address ? (
            <>
              ...
              <Dropdown align="end">
                ...
                <Dropdown.Content className="bg-base-100 dark:bg-base-200 mt-2 grid max-h-[80vh] w-full gap-4 p-4 md:w-48">
                  <>
                    <CopyToClipboardButton
                      size="sm"
                      copyText={address}
                    ...
                    >
                      View account on {chain?.blockExplorers?.default.name}
                    </LinkButton>
                    <Button
                      size="sm"
                      variant="error"
