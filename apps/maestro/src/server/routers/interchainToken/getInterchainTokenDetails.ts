...
import { stellarChainConfig, suiChainConfig, xrplChainConfig } from "~/config/chains";
  ...
  .query(async ({ input, ctx }) => {
    ...
    if (!tokenRecord && input.chainId === xrplChainConfig.id) {
      ...
      if (input.tokenAddress === 'xrp') {
        ...
        tokenRecord =
          await ctx.persistence.postgres.getInterchainTokenByTokenId('0xba5a21ca88ef6bba2bfff5088994f90e1077e2a1cc3dcc38bd261f00fce2824f'); // TODO: derive?
